...
library Constants {
    ...
    /// @dev Swap Id for Uniswap V3, to be used in the uniswapV3SwapCallback function
    bytes32 internal constant UNI_V3_SWAP_ID = keccak256("UNI_V3_SWAP_ID");

    /// @dev Swap Id for Sushiswap V3, to be used in the uniswapV3SwapCallback function
    bytes32 internal constant SUSHI_V3_SWAP_ID = keccak256("SUSHI_V3_SWAP_ID");
}
