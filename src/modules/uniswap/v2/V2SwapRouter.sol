...
abstract contract V2SwapRouter is RouterImmutables, Permit2Payments {
    ...
    function _v2Swap(SwapRoute.Route[] memory path, address recipient, address pair) private {
        unchecked {
            ...
            (address token0,) = RamsesLegacyLibrary.sortTokens(path[0].from, path[0].to);
    ...
    function v2SwapExactOutput(
        ...
        (uint256 amountIn, address firstPair) =
            RamsesLegacyLibrary.getAmountInMultihop(UNISWAP_V2_FACTORY, UNISWAP_V2_PAIR_INIT_CODE_HASH, amountOut, path);
