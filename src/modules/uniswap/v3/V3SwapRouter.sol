...
import {IRamsesV3Pool} from "../../../interfaces/shadowExchange/IRamsesV3Pool.sol";
...
abstract contract V3SwapRouter is RouterImmutables, Permit2Payments, IUniswapV3SwapCallback {
        ...
        returns (int256 amount0Delta, int256 amount1Delta, bool zeroForOne)
    {
        ...
        (amount0Delta, amount1Delta) = IRamsesV3Pool(computePoolAddress(tokenIn, tokenOut, tickSpacing)).swap(
            recipient,
            zeroForOne,
            amount,
