...
deploy-router-sonic:; forge script script/deploy/DeployTomoSwapRouter.s.sol:DeployTomoSwapRouter --rpc-url ${SONIC_RPC_URL} --broadcast --verify --etherscan-api-key ${SONIC_API_KEY}