...
contract UniswapV3Test is Test, PermitSignature {
    ...
    IERC20 constant USDC = IERC20(0xd01c252D92554eC19c50Da53348f85117C23c431); // token1 - 3000
    
    IQuoterV2 constant QUOTERV2 = IQuoterV2(0xC2dA52c56cd52CaBDf299dB22E7D43Ae2de4962d);
    IPermit2 constant PERMIT2 = IPermit2(0x5d47029371233B4925824fA0EeF8F3B4195bbac4);
    ...
    function test_checkInitialState() public view {
        ...
        (uint160 amount, uint48 expiration, uint48 nonce) = PERMIT2.allowance(user, address(USDT), address(router));
        assertEq(amount, 0);
    ...
    // USDT -> USDC 3000 fee
    function test_singleSwapExactInput() public airdropUsdt {
        ...
        assertEq(USDT.balanceOf(user), BALANCE - AMOUNT);
