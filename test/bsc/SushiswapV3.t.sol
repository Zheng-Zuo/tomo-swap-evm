...
contract SushiswapV3Test is Test, PermitSignature {
    address user;
    ...
    IQuoterV2 constant QUOTERV2 = IQuoterV2(0xb1E835Dc2785b52265711e17fCCb0fd018226a6e);
    ...
    function test_singleSwapExactInput() public airdropSushi {
        ...
        bytes memory commands = abi.encodePacked(
            ...
            bytes1(uint8(Commands.SUSHI_V3_SWAP_EXACT_IN))
        );
        ...
        assertEq(WBNB.balanceOf(user), amountOut);
    }

    // SUSHI -> WBNB 3000 fee -> USDT 500 fee
