...
contract UniswapV3Test is Test, PermitSignature {
    ...
    IERC20 constant USDT = IERC20(0xfde4C96c8593536E31F229EA8f37b2ADa2699bb2); // 500
    IERC20 constant USDC = IERC20(0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913); // 100

    IQuoterV2 constant QUOTERV2 = IQuoterV2(0x3d4e44Eb1374240CE5F1B871ab261CD16335B76a);
