...
contract PancakeswapV2Test is Test, PermitSignature {
    ...
    IERC20 constant USDT = IERC20(0xfde4C96c8593536E31F229EA8f37b2ADa2699bb2); 
    ...
    // address(CAKE) < address(WETH)
    // token0:CAKE; token1: WETH
    ...
    // Multi-hop
    // USDC -> USDT -> WETH -> ETH
    function test_multiHopSwapExactInputUnwrap() public airdropUsdt {
