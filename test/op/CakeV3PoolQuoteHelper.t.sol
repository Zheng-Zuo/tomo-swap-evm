...
contract CakeV3PoolQuoteHelperTest is Test {
    ...
    IPancakeV3Pool constant UNI_V3_WETH_USDT_3000_POOL = IPancakeV3Pool(0xdd0c6bAe8Ad5998c358b823df15A2A4181Da1b80);
    IWETH9 constant WETH = IWETH9(0x4200000000000000000000000000000000000006); // token0
    IERC20 constant USDT = IERC20(0x94b008aA00579c1307B0EF2c499aD98a8ce58e58); // token1
    ...
    function test_quote0For1(int256 amountIn) public {
        vm.assume(0.01 ether < amountIn && amountIn <= 5 ether); // WETH decimal on ARB is 18
