...
contract UniswapV3Test is Test, PermitSignature {
    ...
    IERC20 constant USDT = IERC20(0xdAC17F958D2ee523a2206206994597C13D831ec7); // 100
    IERC20 constant WBTC = IERC20(0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599); // 500
    ...
    function test_checkInitialState() public view {
        ...
        uint256 userBtcbBalance = WBTC.balanceOf(user);
        ...
        (amount, expiration, nonce) = PERMIT2.allowance(user, address(WBTC), address(router));
        assertEq(amount, 0);
        assertEq(expiration, 0);
        assertEq(nonce, 0);
    }
    ...
    // WETH -> USDT 100 fee -> WBTC 500 fee
